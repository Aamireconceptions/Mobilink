...
public class LifestyleFragment extends Fragment implements OnFilterChangeListener,
    ...
    private void init(View v, LayoutInflater inflater)
    {
        ...
        FilterOnClickListener clickListener = new FilterOnClickListener(activity, CategoryUtils.CT_LIFESTYLE);
    ...
    public void onRefresh() {
        ...
        CategoryUtils.showSubCategories(activity, CategoryUtils.CT_LIFESTYLE);
    ...
    public void filterTagUpdate()
    {
        ...
        String categories = CategoryUtils.getSelectedSubCategoriesForTag(CategoryUtils.CT_LIFESTYLE);
        ...
        if(adapter.listingType.equals("deals"))
        {
            if(!filter.isEmpty())
            {
                adapter.subcategoryParent = CategoryUtils.CT_LIFESTYLE;
