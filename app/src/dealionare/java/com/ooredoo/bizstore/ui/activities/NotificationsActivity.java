...
public class NotificationsActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void initNotificationsData() {
        ...
        notifications.add(new Notification(4, true, R.drawable.ic_electronics, getString(R.string.lifestyle), "lifestyle"));
        notifications.add(new Notification(5, true, R.drawable.ic_entertainment, getString(R.string.entertainment), "entertainment"));
    }
