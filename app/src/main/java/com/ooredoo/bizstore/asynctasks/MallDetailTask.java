 ...
 * @since 26-Jun-15.
 */
public class MallDetailTask extends BaseAsyncTask<String, Void, String> {
    private MallDetailActivity mallDetailActivity;
    ...
    public MallDetailTask(MallDetailActivity mallDetailActivity, ProgressBar progressBar,
                          SnackBarUtils snackBarUtils) {
        this.mallDetailActivity = mallDetailActivity;
    ...
    protected void onPreExecute() {
        ...
        dialog = DialogUtils.createCustomLoader(mallDetailActivity, mallDetailActivity.getString(R.string.please_wait));
            ...
            try {
                ...
                if(businessDetail.resultCode != -1) {
                    if(business != null) {
                        ...
                        mallDetailActivity.populateData(business);
                    }
                }
