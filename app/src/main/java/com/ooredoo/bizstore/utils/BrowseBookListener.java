...
import com.ooredoo.bizstore.ui.activities.SearchBookContentsActivity;
...
public final class BrowseBookListener implements AdapterView.OnItemClickListener {
  ...
  public BrowseBookListener(SearchBookContentsActivity activity, List<SearchBookContentsResult> items) {
